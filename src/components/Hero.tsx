        ...
        <div className="container mx-auto px-4 z-10 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center mb-16">
            <button 
              ...
              className="bg-gradient-to-r from-[#ff00ff] to-[#9d00ff] px-8 py-3 rounded-full text-white font-medium hover:shadow-[0_0_20px_rgba(255,0,255,0.6)] transition-all duration-300 flex items-center justify-center gap-2 group"
            >
              Get Started 
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            
            <button className="px-8 py-3 rounded-full text-white font-medium border border-white/30 hover:border-[#00ff9d] hover:text-[#00ff9d] transition-all duration-300 backdrop-blur-sm bg-white/5">
              Learn More
            </button>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
            ...
            <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm p-4 rounded-xl">
              <UserCircle className="w-8 h-8 text-[#ff00ff]" />
              <span>Username Delivery</span>
            </div>
            
            <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm p-4 rounded-xl">
              <Gift className="w-8 h-8 text-[#9d00ff]" />
